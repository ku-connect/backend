...
async function getMyProflie(req: Request, res: Response) {
  ...
  const profileWithInterests =
    await profileService.getProfileWithInterestsByUserId(userId, userId);
...
async function getProfileByUserId(req: Request, res: Response) {
  ...
  const profileWithInterests =
    await profileService.getProfileWithInterestsByUserId(id, userId);
...
async function updateMyInterests(req: Request, res: Response) {
  ...
  await profileService.updateUserInterest(userId, interests);
